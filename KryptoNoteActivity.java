        ...
        try {
            {
                ...
                String d = dataView.getText().toString();
                Cipher myCipher = new Cipher(k);
                String cipherString = myCipher.encrypt(d);
                ((EditText) findViewById(R.id.data)).setText(cipherString);
        ...
        try {
            {
                ...
                String d = dataView.getText().toString();
                Cipher myCipher = new Cipher(k);
                String cipherString = myCipher.decrypt(d);
                ((EditText) findViewById(R.id.data)).setText(cipherString);
